...
Feature: Concept Relation Type and Role Type
  ...
  Scenario: Relation types can have keys
    ...
    When put relation type: marriage
    When relation(marriage) set relates role: spouse
    When relation(marriage) set has has type @key: license
    Then relation(marriage) get has has types @key contain:
      | license |
    When transaction commits
    When session opens transaction of type: read
    Then relation(marriage) get has has types @key contain:
  ...
  Scenario: Relation types can remove keys
    ...
    When relation(marriage) set relates role: spouse
    When relation(marriage) set has has type @key: license
    When relation(marriage) set has has type @key: certificate
    When relation(marriage) remove has has type @key: license
    Then relation(marriage) get has has types @key do not contain:
      | license |
    When transaction commits
    When session opens transaction of type: write
    When relation(marriage) remove has has type @key: certificate
    Then relation(marriage) get has has types @key do not contain:
      | license     |
      | certificate |
  ...
  Scenario: Relation types cannot have keys of attributes that are not keyable
    ...
    When relation(employment) set has has type @key: contract-years
    When relation(employment) set has has type @key: reference
    When relation(employment) set has has type @key: start-date
    Then relation(employment) set has has type @key: is-permanent; throws exception
    Then relation(employment) set has has type @key: salary; throws exception
  ...
  Scenario: Relation types can inherit keys and attributes
    ...
    When relation(employment) set has has type @key: employment-reference
    ...
    When relation(contractor-employment) set has has type @key: contractor-reference
    When relation(contractor-employment) set has attribute type: contractor-hours
    Then relation(contractor-employment) get has has types @key contain:
    ...
    When relation(parttime-employment) set has has type @key: parttime-reference
    When relation(parttime-employment) set has attribute type: parttime-hours
    Then relation(parttime-employment) get has has types @key contain:
      | employment-reference |
      | contractor-reference |
      | parttime-reference   |
  ...
  Scenario: Relation types can override inherited keys and attributes
    ...
    When relation(contractor-employment) set abstract: true
    When relation(contractor-employment) set supertype: employment
    When relation(contractor-employment) set has has type @key: contractor-reference as employment-reference
    When relation(contractor-employment) set has attribute type: contractor-hours as employment-hours
    Then relation(contractor-employment) get has has types @key contain:
      | contractor-reference |
    Then relation(contractor-employment) get has has types @key do not contain:
      | employment-reference |
    Then relation(contractor-employment) get has attribute types contain:
      | contractor-reference |
      | contractor-hours     |
    ...
    When relation(parttime-employment) set has has type @key: parttime-reference as contractor-reference
    ...
    Then relation(parttime-employment) get has has types @key contain:
      | parttime-reference |
    Then relation(parttime-employment) get has has types @key do not contain:
      | employment-reference |
      | contractor-reference |
    Then relation(parttime-employment) get has attribute types contain:
      | parttime-reference |
  ...
  Scenario: Relation types can redeclare keys as attributes
    ...
    When put relation type: marriage
    When relation(marriage) set relates role: spouse
    When relation(marriage) set has has type @key: date
    When relation(marriage) set has has type @key: license
    When relation(marriage) set has attribute type: date
    When transaction commits
    When session opens transaction of type: write
  ...
  Scenario: Relation types can redeclare attributes as keys
    ...
    Then relation(marriage) set has has type @key: date
    When transaction commits
    When session opens transaction of type: write
    When relation(marriage) set has has type @key: license
  ...
  Scenario: Relation types cannot redeclare inherited keys and attributes
    ...
    When put relation type: contractor-employment
    When relation(contractor-employment) set supertype: employment
    Then relation(contractor-employment) set has has type @key: employment-reference; throws exception
  ...
  Scenario: Relation types cannot redeclare inherited/overridden key/has attribute types
    ...
    When put relation type: parttime-employment
    When relation(parttime-employment) set supertype: contractor-employment
    Then relation(parttime-employment) set has has type @key: employment-reference; throws exception
    Then relation(parttime-employment) set has has type @key: contractor-reference; throws exception
  ...
  Scenario: Relation types cannot override declared keys and attributes
    ...
    Then relation(employment) set has has type @key: social-security-number as reference; throws exception
  ...
  Scenario: Relation types cannot override inherited keys and attributes other than with their subtypes
    ...
    When put relation type: contractor-employment
    When relation(contractor-employment) set supertype: employment
    Then relation(contractor-employment) set has has type @key: contractor-reference as employment-reference; throws exception
