...
Feature: TypeDB HTTP Endpoint
  ...
  Scenario: Transaction-based read rows queries can include and exclude instance types
    # Does not affect
  ...
  Scenario: Transaction-based write rows queries can include and exclude instance types
    # Does not affect
    Given set query option include_instance_types to: false
    Given connection open schema transaction for database: typedb
    Given typeql schema query
  ...
  Scenario: Transaction-based read document queries are not controlled by the include_instance_types option
    # Does not affect
    Given set query option include_instance_types to: false
    Given connection open schema transaction for database: typedb
    Given typeql schema query
  ...
  Scenario: Transaction-based write documents queries are not controlled by the include_instance_types option
    # Does not affect
    Given set query option include_instance_types to: false
    Given connection open schema transaction for database: typedb
    Given typeql schema query
