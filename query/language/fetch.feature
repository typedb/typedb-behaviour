...
Feature: TypeQL Fetch Query
  ...
  Scenario Outline: attributes and values of <value-type> type can be fetched
    ...
    Examples:
      ...
      | decimal     | 1234567890.0001234567890dec                 | "1234567890.000123456789"                     | "1234567890.0001234567890"                   |
      | decimal     | 0.0000000000000000001dec                    | "0.0000000000000000001"                       | 0.000000000000000001                         |
